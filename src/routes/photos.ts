...
export async function photoRoutes(fastify: FastifyInstance) {
  ...
  fastify.post('/api/photos/upload-url', {
  ...
  fastify.post('/api/photos/webhook/processed', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
