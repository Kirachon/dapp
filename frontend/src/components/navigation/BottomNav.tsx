...
export default function BottomNav() {
  ...
  // Don't show navigation on auth pages, onboarding, or landing
  if (
    pathname === '/' ||
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-[var(--color-border)] z-50 lg:hidden">
